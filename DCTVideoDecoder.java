        ...
        try (Scanner scanner = new Scanner(line)) {
            ...
            if (scanner.hasNextInt()) {
                ...
                if (scanner.hasNextInt()) {
                    ...
                    macroblock.motion_vec = new int[] { dx, dy };
                }
            }
        }
    ...
    public void readFrameCompressAndWrite(String inputFilePath, int width, int height, int totalFrames,
        ...
        try (FileInputStream fileInputStream = new FileInputStream(inputFilePath);
            ...
            while (fileChannel.read(buf) > 0) {
                ...
                System.out.println("Read frame with vecs " + frameCount++);
                ...
                for (Macroblock mb : macroblocks) {
                    ...
                    //Append motion vector to the string builder
                    if (mb.motion_vec != null) {
                        sb.append(mb.motion_vec[0]).append(" ").append(mb.motion_vec[1]).append(" ");
                    } else {
                        sb.append("0 0 ");
                    }
